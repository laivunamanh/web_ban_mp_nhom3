...
<body>
    ...
    <header>
        <div class="logo">
            <a href="index.php"><img src="img/looo.jpg" alt=""></a>
        </div>
        ...
        <div class="giohang">
            <a href="index.php?act=giohang">
                <img src="img/cart.png" alt="" class="btn-button">
                <span style="display: <?= (isset($total_prod_giohang) && $total_prod_giohang > 0) ? 'flex' : 'none' ?>"
                    id="total_prod_giohang" class="soluong"><?= $total_prod_giohang ?></span>
            </a>
        </div>
    </header>
